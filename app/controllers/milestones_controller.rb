class MilestonesController < ApplicationController
  ...
  # GET /milestones.json
  def index
    @milestones = current_user.milestones.paginate(page: params[:page], per_page: 5)
  end
  ...
  private
    ...
    def milestone_params
      params.require(:milestone).permit(:todo, :review)
    end
    
    def require_same_user
        if current_user != @milestone.user 
            flash[:danger] = "You can view, delete or edit only your milestones"
